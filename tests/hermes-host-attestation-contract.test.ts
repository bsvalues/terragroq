...
describe("binding current HERMES truth", () => {
  ...
  it.each([
    ...
    ["stale guard heartbeat", "operations.heartbeats", { processes: [], heartbeatFiles: [{ path: "C:\\ProgramData\\Hermes\\p40\\p40-watch.heartbeat", writtenAt: "2026-08-27T17:40:00.000Z" }] }, "HERMES_INFERENCE_GOLDEN_DRIFT"],
