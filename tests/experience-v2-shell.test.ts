...
describe("WilliamOS Experience V2 shell", () => {
  ...
  it("keeps The Line transient and grounds object actions in the selected source", () => {
    ...
    expect(source).toContain('["Inspect", "Talk", "Redirect", "Council", pauseAction, forkAction, selectedAgent?.target ? "Review work" : "Review work unavailable"] as const')
  ...
  it("keeps Council advisory and Mission Control spatial", () => {
    ...
    expect(source).toContain('providerLabel === "Local" ? ["Inspect", "Talk", "Council"')
