...
describe("WilliamOS Experience V2 shell", () => {
  ...
  it("keeps The Line transient and grounds object actions in the selected source", () => {
    ...
    expect(source).toContain('action === "Review" || action === "Challenge"')
    ...
    expect(source).toContain('action === "Continue unavailable" || action === "Improve" && Boolean(improveUnavailableReason)')
