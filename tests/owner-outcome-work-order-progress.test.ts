...
describe("owner outcome work-order progress", () => {
  it("promotes exactly the next incomplete work order", () => {
    expect(deriveOrderedWorkOrderStatuses(6, 0)).toEqual([
      "READY",
      "PENDING",
      "PENDING",
      "PENDING",
    ...
    expect(deriveOrderedWorkOrderStatuses(6, 1)).toEqual([
      "COMPLETE",
      "READY",
      "PENDING",
      "PENDING",
    ...
    expect(deriveOrderedWorkOrderStatuses(6, 6)).toEqual([
      "COMPLETE",
      "COMPLETE",
      "COMPLETE",
      "COMPLETE",
  ...
  it("rejects malformed progress instead of inventing readiness", () => {
    ...
    expect(() => deriveOrderedWorkOrderStatuses(6, 7)).toThrow(RangeError)
