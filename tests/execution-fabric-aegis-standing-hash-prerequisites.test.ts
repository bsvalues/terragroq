...
describe("AEGIS standing HASH prerequisite provisioning package", () => {
  ...
  it("pins the exact reviewed package posture, bindings, and standing execution boundary", () => {
    ...
    expect(value.bindings).toEqual([
      ...
      { path: "scripts/execution-fabric/provision/apply-aegis-standing-hash-prerequisites.mjs", sha256: "c90de483e1e9e8c7199cfda273fe1b470276f66acca4af2627aed263a098aed8", textNormalization: "LF" },
