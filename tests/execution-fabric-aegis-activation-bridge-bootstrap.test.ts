...
describe("AEGIS activation bridge bootstrap authority", () => {
  ...
  it("upgrades only the exact reviewed activation-host predecessor", () => {
    const destination="/usr/local/libexec/williamos-aegis-remote-dev-activation-host.mjs", current="1c46a0ff878715df84811d159845802b6543961d3d90f4db056d21b547f56635"
