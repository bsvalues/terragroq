...
- One proposal transaction has a 5,400,000 ms aggregate resident deadline: at most three correction attempts, each retaining the reviewed 1,800,000 ms kernel turn budget. The outer proposal route allows 7,200 seconds and the HTTPS proxy allows 121 minutes, reserving a bounded 30-minute host-overhead envelope for worktree setup, Git verification, contained validation, publication, and cleanup around the 90-minute resident ceiling.
