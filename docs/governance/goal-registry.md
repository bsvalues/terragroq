...
Status: `ACTIVE / WO-MAO-047 AND WO-MAO-049 COMPLETE / WO-MAO-048 READY`
...
edges from WO-MAO-035/036. WO-MAO-035 through WO-MAO-047 and WO-MAO-049 are now `COMPLETE`;
WO-MAO-048 is `READY`.
