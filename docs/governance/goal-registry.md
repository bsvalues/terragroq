...
Status: `ACTIVE / WO-MAO-046 COMPLETE / WO-MAO-047 AND WO-MAO-049 READY`
...
edges from WO-MAO-035/036. WO-MAO-035 through WO-MAO-046 are now `COMPLETE`; WO-MAO-047 and
WO-MAO-049 are `READY`.
