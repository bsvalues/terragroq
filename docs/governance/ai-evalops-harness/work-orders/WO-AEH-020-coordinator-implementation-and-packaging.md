...
```text
WORK_ORDER: WO-AEH-020
TITLE: Coordinator implementation and packaging
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-020 without expanding authority or scope.
...
OBJECTIVE: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof.
SCOPE: Coordinator implementation and packaging; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof.
...
ACCEPTANCE_CRITERIA: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; migration, concurrency, idempotency, and restart tests; prove exact declared outcome: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; migration, concurrency, idempotency, and restart tests; prove exact declared outcome: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-020-coordinator-implementation-and-packaging.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-021, WO-AEH-052) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-021, WO-AEH-052
...
requiredOutputs:
  - "Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof."
requiredValidation:
  ...
  - "prove exact declared outcome: Implement Atlas-backed leadership, automatic-restart packaging, health/readiness and safe-replacement contracts with deterministic tests; no live installation or restart proof."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-020-coordinator-implementation-and-packaging.md"
