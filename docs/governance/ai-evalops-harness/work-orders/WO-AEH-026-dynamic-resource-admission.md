# WO-AEH-026 — Dynamic resource admission
...
```text
WORK_ORDER: WO-AEH-026
TITLE: Dynamic resource admission
...
RISK_CLASS: R2
DEPENDS_ON: WO-AEH-023, WO-AEH-024, WO-AEH-025, WO-AEH-050
REPO: terragroq
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-026 without expanding authority or scope.
...
OBJECTIVE: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves.
SCOPE: Dynamic resource admission; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves.
...
ACCEPTANCE_CRITERIA: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-026-dynamic-resource-admission.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-027) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
requiredOutputs:
  - "Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves."
requiredValidation:
  - "focused unit and negative tests"
  - "changed-path and secret scan"
  - "git diff --check"
  - "independent review"
  - "prove exact declared outcome: Hard gates for live RAM/disk/VRAM, pressure, temperature, leases, queue, identity, transfer cost and protected reserves."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-026-dynamic-resource-admission.md"
