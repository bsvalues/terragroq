...
```text
WORK_ORDER: WO-AEH-021
TITLE: Common worker protocol
...
RISK_CLASS: R2
DEPENDS_ON: WO-AEH-019, WO-AEH-020
REPO: terragroq
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-021 without expanding authority or scope.
...
OBJECTIVE: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite.
SCOPE: Common worker protocol; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite.
...
ACCEPTANCE_CRITERIA: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-021-common-worker-protocol.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-022, WO-AEH-023, WO-AEH-024) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-022, WO-AEH-023, WO-AEH-024
...
requiredOutputs:
  - "Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite."
requiredValidation:
  - "focused unit and negative tests"
  - "changed-path and secret scan"
  - "git diff --check"
  - "independent review"
  - "prove exact declared outcome: Signed envelopes, worker pull, heartbeat, cancellation, digests, revocation and conformance suite."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-021-common-worker-protocol.md"
