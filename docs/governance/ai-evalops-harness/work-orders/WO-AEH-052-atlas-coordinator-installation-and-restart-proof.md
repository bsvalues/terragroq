# WO-AEH-052 — Atlas coordinator installation and restart proof
...
```text
WORK_ORDER: WO-AEH-052
TITLE: Atlas coordinator installation and restart proof
...
RISK_CLASS: R3
DEPENDS_ON: WO-AEH-020, WO-AEH-044
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-052 without expanding authority or scope.
...
OBJECTIVE: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency.
SCOPE: Atlas coordinator installation and restart proof; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency.
...
ACCEPTANCE_CRITERIA: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: single leader; process and service restart with automatic recovery within five minutes; stale instance fenced; durable attempts reconciled; no OMEN dependency; uninstall rollback proof; prove exact declared outcome: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency.
VALIDATION_REQUIRED: single leader; process and service restart with automatic recovery within five minutes; stale instance fenced; durable attempts reconciled; no OMEN dependency; uninstall rollback proof; prove exact declared outcome: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency.
...
ROLLBACK_OR_REVERSAL: Stop and disable the coordinator, fence the old instance, reconcile durable attempts, restore the signed prior unit and configuration, and prove uninstall.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-052-atlas-coordinator-installation-and-restart-proof.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-033) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
Environments:
- `Atlas-live-preauthorized-coordinator-boundary`
...
requiredOutputs:
  - "Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency."
requiredValidation:
  - "single leader"
  - "process and service restart with automatic recovery within five minutes"
  - "stale instance fenced"
  - "durable attempts reconciled"
  - "no OMEN dependency"
  - "uninstall rollback proof"
  - "prove exact declared outcome: Install the reviewed coordinator on Atlas, prove single leadership, automatic restart, fenced replacement, health/readiness, uninstall rollback and no OMEN dependency."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-052-atlas-coordinator-installation-and-restart-proof.md"
