# WO-AEH-049 — Setup, topology and metadata reconciliation
...
```text
WORK_ORDER: WO-AEH-049
TITLE: Setup, topology and metadata reconciliation
...
RISK_CLASS: R1
DEPENDS_ON: WO-AEH-002, WO-AEH-003
REPO: terragroq
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-049 without expanding authority or scope.
...
OBJECTIVE: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata.
SCOPE: Setup, topology and metadata reconciliation; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata.
...
ACCEPTANCE_CRITERIA: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-049-setup-topology-and-metadata-reconciliation.md
...
requiredOutputs:
  - "Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata."
requiredValidation:
  - "focused unit and negative tests"
  - "changed-path and secret scan"
  - "git diff --check"
  - "independent review"
  - "prove exact declared outcome: Reconcile README/service map with the three-node truth; document supported/optional/deprecated surfaces, exact commands/env variables, package/workspace ownership and root package metadata."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-049-setup-topology-and-metadata-reconciliation.md"
