# WO-AEH-043 — Live restore and retention proof
...
```text
WORK_ORDER: WO-AEH-043
TITLE: Live restore and retention proof
...
RISK_CLASS: R3
DEPENDS_ON: WO-AEH-011, WO-AEH-012, WO-AEH-013
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-043 without expanding authority or scope.
...
OBJECTIVE: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence.
SCOPE: Live restore and retention proof; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence.
...
ACCEPTANCE_CRITERIA: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; prove exact declared outcome: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-043-live-restore-and-retention-proof.md
...
requiredOutputs:
  - "Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence."
requiredValidation:
  - "focused unit and negative tests"
  - "changed-path and secret scan"
  - "git diff --check"
  - "independent review"
  - "prove exact declared outcome: Run preauthorized disposable restores, application invariants and retention dry-run/live proof while preserving every protected generation; retain measured RPO/RTO evidence."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-043-live-restore-and-retention-proof.md"
