# WO-AEH-035 — Network-boundary and AI-abuse evaluation
...
```text
WORK_ORDER: WO-AEH-035
TITLE: Network-boundary and AI-abuse evaluation
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-035 without expanding authority or scope.
...
OBJECTIVE: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests.
SCOPE: Network-boundary and AI-abuse evaluation; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests.
...
ACCEPTANCE_CRITERIA: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; cgroup, process-tree, network, scratch, timeout, and cleanup tests; zero prohibited events and complete immutable evidence; prove exact declared outcome: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; cgroup, process-tree, network, scratch, timeout, and cleanup tests; zero prohibited events and complete immutable evidence; prove exact declared outcome: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-035-network-boundary-and-ai-abuse-evaluation.md
...
requiredOutputs:
  - "Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests."
requiredValidation:
  ...
  - "cgroup, process-tree, network, scratch, timeout, and cleanup tests"
  - "zero prohibited events and complete immutable evidence"
  - "prove exact declared outcome: Atlas denial plus IPv6/proxy/raw-IP/redirect bypass, prompt injection, tool allowlist, output ceiling, model drift and repeated-request tests."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-035-network-boundary-and-ai-abuse-evaluation.md"
