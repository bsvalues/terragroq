...
```text
WORK_ORDER: WO-AEH-002
TITLE: Current-state and drift inventory
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-002 without expanding authority or scope.
...
OBJECTIVE: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift.
SCOPE: Current-state and drift inventory; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
ALLOWED_FILES_OR_AREAS: terragroq:docs/governance; HermesLab:README.md; HermesLab:SERVICE-MAP.md; terragroq:docs/reports/ai-evalops-harness
FILES_ALLOWED: terragroq:docs/governance; HermesLab:README.md; HermesLab:SERVICE-MAP.md; terragroq:docs/reports/ai-evalops-harness
...
DELIVERABLES: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift.
...
ACCEPTANCE_CRITERIA: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: timestamped source-attributed inventory; declared-versus-observed reconciliation; no-mutation evidence; independent review; prove exact declared outcome: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift.
VALIDATION_REQUIRED: timestamped source-attributed inventory; declared-versus-observed reconciliation; no-mutation evidence; independent review; prove exact declared outcome: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-002-current-state-and-drift-inventory.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-003, WO-AEH-004, WO-AEH-005, WO-AEH-049) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-003, WO-AEH-004, WO-AEH-005, WO-AEH-049
...
requiredOutputs:
  - "Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift."
requiredValidation:
  - "timestamped source-attributed inventory"
  - "declared-versus-observed reconciliation"
  - "no-mutation evidence"
  - "independent review"
  - "prove exact declared outcome: Timestamped read-only inventory of services, ports, tasks, containers, images, models, disks, backups, identities and config/runtime drift."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-002-current-state-and-drift-inventory.md"
