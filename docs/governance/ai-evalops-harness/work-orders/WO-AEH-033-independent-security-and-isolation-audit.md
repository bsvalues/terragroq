# WO-AEH-033 — Independent security and isolation audit
...
```text
WORK_ORDER: WO-AEH-033
TITLE: Independent security and isolation audit
...
RISK_CLASS: R2
DEPENDS_ON: WO-AEH-007, WO-AEH-046, WO-AEH-047, WO-AEH-048, WO-AEH-045, WO-AEH-051, WO-AEH-052
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-033 without expanding authority or scope.
...
OBJECTIVE: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived.
SCOPE: Independent security and isolation audit; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived.
...
ACCEPTANCE_CRITERIA: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; zero prohibited events and complete immutable evidence; prove exact declared outcome: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; zero prohibited events and complete immutable evidence; prove exact declared outcome: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-033-independent-security-and-isolation-audit.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-034, WO-AEH-036) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-034, WO-AEH-036
...
requiredOutputs:
  - "Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived."
requiredValidation:
  ...
  - "prove exact declared outcome: Identity, sudo, Docker, coordinator, secret, injection, egress, deployment and evidence review; no critical finding waived."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-033-independent-security-and-isolation-audit.md"
