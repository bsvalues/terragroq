# WO-AEH-050 — AEGIS bounded test adapter
...
```text
WORK_ORDER: WO-AEH-050
TITLE: AEGIS bounded test adapter
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-050 without expanding authority or scope.
...
OBJECTIVE: Separate test-operation profile, read-only source, isolated scratch, declared test artifacts, exact network policy, evidence and cancellation cleanup.
SCOPE: AEGIS bounded test adapter; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Separate test-operation profile, read-only source, isolated scratch, declared test artifacts, exact network policy, evidence and cancellation cleanup.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-050-aegis-bounded-test-adapter.md
...
requiredOutputs:
  - "Separate test-operation profile, read-only source, isolated scratch, declared test artifacts, exact network policy, evidence and cancellation cleanup."
requiredValidation:
  ...
  - "prove exact declared outcome: Separate test-operation profile, read-only source, isolated scratch, declared test artifacts, exact network policy, evidence and cancellation cleanup."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-050-aegis-bounded-test-adapter.md"
