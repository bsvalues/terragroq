# WO-AEH-040 — Seven-day unattended soak
...
```text
WORK_ORDER: WO-AEH-040
TITLE: Seven-day unattended soak
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-040 without expanding authority or scope.
...
OBJECTIVE: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts.
SCOPE: Seven-day unattended soak; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts.
...
ACCEPTANCE_CRITERIA: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: seven additional continuous days after the pilot; at least 25 heterogeneous useful jobs; at least 200 admitted Hermes requests; at least 1000 settled attempts; required coordinator restarts node reboots outages safe retry and offsite restore; zero prohibited events; 100 percent terminal receipts and evidence replication; exact SLO query windows recorded; prove exact declared outcome: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts.
VALIDATION_REQUIRED: seven additional continuous days after the pilot; at least 25 heterogeneous useful jobs; at least 200 admitted Hermes requests; at least 1000 settled attempts; required coordinator restarts node reboots outages safe retry and offsite restore; zero prohibited events; 100 percent terminal receipts and evidence replication; exact SLO query windows recorded; prove exact declared outcome: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts.
...
ROLLBACK_OR_REVERSAL: Engage kill switch and deactivate the lane; preserve all evidence; issue an evidence-backed rejection and a narrowly scoped remediation WO.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-040-seven-day-unattended-soak.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-041) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-041
NEXT_ON_BLOCK: DEACTIVATED / CERTIFICATION_REJECTED / REMEDIATION_WO_REQUIRED; preserve all evidence and do not restart the soak implicitly.
...
Contracts:
- `wo-aeh-040-outcome`
- `certification-safety-gates`

Environments:
- `preauthorized-live-certification`
...
requiredOutputs:
  - "Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts."
requiredValidation:
  - "seven additional continuous days after the pilot"
  - "at least 25 heterogeneous useful jobs"
  - "at least 200 admitted Hermes requests"
  - "at least 1000 settled attempts"
  - "required coordinator restarts node reboots outages safe retry and offsite restore"
  - "zero prohibited events"
  - "100 percent terminal receipts and evidence replication"
  - "exact SLO query windows recorded"
  - "prove exact declared outcome: Run seven additional continuous days after the pilot with at least 25 heterogeneous useful jobs, 200 admitted Hermes requests, 1,000 settled attempts, required restarts/reboots/outages/safe retry/off-site restore, zero prohibited events, and complete terminal receipts."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-040-seven-day-unattended-soak.md"
