# WO-AEH-030 — Monitoring stack configuration
...
PURPOSE: Deliver exactly the outcome named by WO-AEH-030 without expanding authority or scope.
...
OBJECTIVE: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation.
SCOPE: Monitoring stack configuration; only the repository-qualified areas, contracts, environments, and protected resources in this packet.
...
DELIVERABLES: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation.
...
ACCEPTANCE_CRITERIA: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation; every required validation below passes including fail-closed negatives; rollback is verified; evidence is immutable; and independent review has no blocking findings.
VALIDATION: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; payload leakage negatives and alert fire/recover/dead-man proof; prove exact declared outcome: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation.
VALIDATION_REQUIRED: focused unit and negative tests; changed-path and secret scan; git diff --check; independent review; typed fail-closed and rollback verification; payload leakage negatives and alert fire/recover/dead-man proof; prove exact declared outcome: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation.
...
EVIDENCE_PATH: terragroq:docs/reports/ai-evalops-harness/WO-AEH-030-monitoring-stack-configuration.md

SUCCESS_TRANSITION: Record the verified result and release only dependency successors (WO-AEH-031, WO-AEH-038, WO-AEH-044) to fresh dependency, reservation, and AUTHORITY_MATCH evaluation; success grants no authority.
...
NEXT_ON_PASS: WO-AEH-031, WO-AEH-038, WO-AEH-044
...
requiredOutputs:
  - "Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation."
requiredValidation:
  ...
  - "prove exact declared outcome: Versioned central metrics/logs/traces, Windows/Linux/GPU exporter, blackbox, retention and resource-budget configuration; no live installation."
reviewRequirements:
...
stopConditions:
  ...
  - issue-357-reuse
evidenceTargets:
  - "terragroq:docs/reports/ai-evalops-harness/WO-AEH-030-monitoring-stack-configuration.md"
