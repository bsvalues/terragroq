...
worker/coordinator recovery, WO-MAO-048 proved provider outage/failover handling, and WO-MAO-049
proved stale-base/CI/review/merge-race handling. WO-MAO-050 is `READY`; the next ordered gate is
WO-MAO-050.
