...
WO-MAO-035/036. WO-MAO-035 through WO-MAO-049 are now `COMPLETE`; WO-MAO-050 is
`READY`, and the selected MAO loop resumes at WO-MAO-050 without owner contact.
The program
