...
WO-MAO-035/036. WO-MAO-035 through WO-MAO-047 and WO-MAO-049 are now `COMPLETE`; WO-MAO-048 is
`READY`, and the selected MAO loop resumes at WO-MAO-048 without owner contact.
The program
