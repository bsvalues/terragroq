...
WO-MAO-035/036. WO-MAO-035 through WO-MAO-050 are now `COMPLETE`; WO-MAO-051 is
`READY`, and the selected MAO loop resumes at WO-MAO-051 without owner contact.
The program
