...
WO-MAO-035/036. WO-MAO-035 through WO-MAO-046 are now `COMPLETE`; WO-MAO-047 and WO-MAO-049 are
`READY`, and the selected MAO loop resumes at WO-MAO-047 without owner contact.
The program
