...
isolated-workspace manager, the WO-MAO-026 reservation-aware handoff contract, and the provider assessments
...
`WO-MAO-027`; later Phase 3 Work Orders remain pending on their declared dependencies. The program
