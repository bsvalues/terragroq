...
WO-MAO-035/036. WO-MAO-035 through WO-MAO-051 are now `COMPLETE`; WO-MAO-052 is
`READY`, and the selected MAO loop resumes at WO-MAO-052 without owner contact.
The program
