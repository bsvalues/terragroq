...
The resolver may not return `NO_ACTIVE_PROGRAM` while an approved owner outcome remains incomplete and useful bounded WilliamOS-native R0/R1 work remains available inside authority.
