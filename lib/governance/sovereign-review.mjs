...
export function generateSovereignReviewerKeypair() {
...
export function sovereignReviewerSigningKeyFromBase64(value) {
 ...
 */
export function signSovereignReview(review, signingKey) {
 ...
 */
export function verifySovereignReview(attestation, sovereignReviewerPublicKeys) {
...
export function assertDomainSeparation(attestation) {
