...
const EXPECTED_WORK_ORDERS: readonly ExpectedWorkOrder[] = [
  {
    ...
    authorityGrantId: 13,
    status: "active",
    // work_order.updatedAt is a UTC-wall timestamp without timezone. Bind the stored wall value,
    // not the workstation timezone conversion returned by a generic node-postgres Date parser.
    updatedAt: "2026-08-29T15:59:04.953Z",
  ...
  },
  {
    ...
    authorityGrantId: 14,
    status: "active",
    updatedAt: "2026-08-29T15:59:08.550Z",
