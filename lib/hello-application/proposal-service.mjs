...
export function governedPrompt() {
  return [
    ...
    "Use the available file-editing tools now. Do not substitute prose or fenced code blocks for file edits, and do not say that you will edit a file without editing it on disk.",
...
function residentCorrectionPrompt(changedPaths, attempt) {
  ...
  return [
    ...
    "Make all three on-disk edits now with the available file-editing tools; do not provide sample code or describe future work.",
    governedPrompt(),
  ].join("\n")
}
