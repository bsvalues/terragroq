...
import { BrainCouncilHermesActivationChecklistExportPanel } from "@/components/brain-council/brain-council-hermes-activation-checklist-export-panel"
...
import { BrainCouncilHermesSandboxChecklistPanel } from "@/components/brain-council/brain-council-hermes-sandbox-checklist-panel"
import { BrainCouncilHermesSkillQuarantinePanel } from "@/components/brain-council/brain-council-hermes-skill-quarantine-panel"
...
import { HermesBlockedDeniedStatePanel } from "@/components/brain-council/hermes-blocked-denied-state-panel"
...
export function BrainCouncilReasoningView() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <BrainCouncilExperimentRegistryPanel />
      ...
      <BrainCouncilFailureEvalCandidatesPanel />

      <BrainCouncilEvalPromotionRubricPanel />
      ...
      <BrainCouncilHermesResearchLinkagePanel />

      <BrainCouncilHermesProcedureReviewPanel />

      <BrainCouncilHermesSkillQuarantinePanel />
      ...
      <BrainCouncilHermesActivationChecklistExportPanel />
    </div>
  )
}
