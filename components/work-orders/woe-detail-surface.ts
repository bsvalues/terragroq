      ...
      proofChain: [
        {
          ...
          evidence: "Evidence reconciliation confirms PR #416/#417 state, blocked non-WilliamOS lanes, and the owner-authorized WOE activation.",
          proofSignal: "The Primary can see why this lane is WilliamOS-native and why Property Workbench/TerraPilot/county work remains closed.",
          href: "/goal-console",
        },
        {
          label: "Implementation proof",
          workOrder: "WO-WILLIAMOS-WOE-DETAIL-SURFACES-002",
          evidence: "The WOE detail model renders the activated program, goal, loop, Work Order sequence, evidence links, and safety posture.",
          proofSignal: "The completed lane is inspectable without adding run buttons, workers, command paths, or runtime authority.",
          href: "/work-orders",
        },
        {
          label: "Safety and rollup proof",
          workOrder: "WO-WILLIAMOS-WOE-DETAIL-SURFACES-003",
          evidence: "The rollup records validation, queue return to NO_ACTIVE_PROGRAM, and blocked production/runtime/protected-data scope.",
          proofSignal: "Completion is readable as proof of reality, not as permission to execute another lane.",
          href: "/audit",
        },
      ],
