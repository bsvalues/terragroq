...
export const MULTI_AGENT_CAPABILITY_INVENTORY = Object.freeze([
  ...
  record({
    ...
    executionClass: "NON_EXECUTABLE",
    claim: "The exact WO-MAO-034<-WO-MAO-033 provider-unavailable edge has canonical authenticated settlement, releasing WO-MAO-034 to READY without completing it or enabling Claude.",
