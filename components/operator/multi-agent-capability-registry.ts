...
export const MULTI_AGENT_CAPABILITY_INVENTORY = Object.freeze([
  ...
  record({
    ...
    executionClass: "NON_EXECUTABLE",
    claim: "WO-MAO-034 now fails closed on the real consumer-specific Claude unavailable-provider settlement gate because the production provider-assessment pin registry contains no active trust record.",
