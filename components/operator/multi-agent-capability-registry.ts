...
export const MULTI_AGENT_CAPABILITY_INVENTORY = Object.freeze([
  ...
  record({
    capabilityId: "failure-recovery-certification-model",
    label: "Failure and recovery certification",
    kind: "CONTROL_PLANE",
    status: "PROVEN",
    executionClass: "NON_EXECUTABLE",
    claim: "WO-MAO-057 certifies the recorded worker death, coordinator restart, provider/network failure, reservation collision, and stale-base recovery classes as static evidence.",
    ...
    restrictions: [
      ...
      "The certification references sealed prior failure/recovery evidence and does not claim new runtime authority",
