...
export const MULTI_AGENT_CAPABILITY_INVENTORY = Object.freeze([
  ...
  record({
    ...
    claim: "The historical WO-MAO-031 role-adapter implementation remains present but is mechanically invalidated pending redesign and re-proof against the hardened WO-MAO-030 contract.",
    ...
    restrictions: [
      ...
      "Historical entrypoint is typed fail-closed; WO-MAO-031 must be redesigned and independently re-proved",
  ...
  record({
    ...
    status: "AVAILABLE_UNPROVEN",
    executionClass: "NON_EXECUTABLE",
    claim: "The historical WO-MAO-034 routing model remains present but is mechanically invalidated until WO-MAO-031 is re-proved and routing is independently re-reviewed.",
    reasonCode: "POST_MERGE_ASSURANCE_INVALIDATED_PENDING_REPROOF",
    ...
    restrictions: [
      ...
      "Historical entrypoint is typed fail-closed; WO-MAO-034 must be re-proved after WO-MAO-031",
  ...
  record({
    ...
    status: "AVAILABLE_UNPROVEN",
    executionClass: "NON_EXECUTABLE",
    claim: "The historical WO-MAO-035 health/reroute model remains present but is mechanically invalidated because caller-supplied providers, stale observations, and stateless breaker input could manufacture proof.",
    reasonCode: "POST_MERGE_ASSURANCE_INVALIDATED_PENDING_REPROOF",
