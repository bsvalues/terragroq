...
export const ACADEMY_LESSONS: AcademyLesson[] = [
  ...
  {
    lessonId: "lesson-trace-ledger-failure-eval",
    title: "Trace Ledger and Failure-to-Eval",
    audience: "Codex operator",
    level: "governance",
    summary: "Explains proof history, failure classification, evidence gaps, confidence movement, and eval candidates as static/read-only records.",
    concepts: ["Trace Ledger", "Failure-to-Eval", "Evidence Gap", "Confidence Movement", "Eval Candidate"],
    ...
    relatedEvidence: ["Trace Ledger surface", "Brain Council Advisory Layer", "WOE evidence clarity"],
    relatedAuthorityGates: ["COMMAND_RUNNER_GATE", "AUTONOMOUS_LOOP_GATE", "MEMORY_WRITE_GATE", "TOOL_CALL_GATE"],
    whatThisTeaches: [
      "Trace records proof history.",
      "Evidence gaps lower or block confidence.",
      "Failure-to-Eval creates candidates only.",
      "Eval implementation remains a future authority gate.",
    ],
    whatThisDoesNotEnable: [
  ...
  {
    lessonId: "lesson-brain-council-advisory-layer",
    title: "Brain Council Advisory Layer",
    audience: "Primary Operator and Codex",
    level: "governance",
    summary: "Explains Council as an advisory, evidence-seeking, authority-gated layer that recommends Work Orders instead of taking action.",
    concepts: ["Brain Council", "Evidence Used", "Confidence", "Risk", "Work Order recommendation", "Authority required"],
    relatedGoal: "GOAL-WOS-003",
    relatedLoop: "WILLIAMOS-BRAIN-COUNCIL-ADVISORY-BATCH-001",
    relatedWorkOrders: ["WO-COUNCIL-001 through WO-COUNCIL-011"],
    relatedEvidence: ["Council advisory surface", "WOE evidence clarity", "Hermes boundary doctrine"],
    relatedAuthorityGates: ["COUNCIL_RUNTIME_GATE", "COMMAND_RUNNER_GATE", "HERMES_ACTIVATION_GATE", "MEMORY_WRITE_GATE"],
    whatThisTeaches: [
      "Council may advise and classify.",
      "Evidence drives confidence.",
      "Recommendations become Work Order packets.",
      "Owner authority remains required before action.",
    ],
    whatThisDoesNotEnable: [
      "Council runtime",
  ...
  {
    lessonId: "lesson-county-ops-knowledge-pack",
    title: "County Ops Knowledge Pack",
    audience: "Primary Operator and Codex",
    level: "advanced",
    summary:
      "Teaches static Washington county-assessor workflows, source hierarchy, evidence, redaction, and authority walls without touching county systems.",
    concepts: ["County Ops", "PACS read-only doctrine", "levy", "BOE", "permit intake", "redaction", "ratio study", "appeals"],
    relatedGoal: "GOAL-COUNTY-001",
    relatedLoop: "LOOP-WILLIAMOS-COUNTY-OPS-001",
    ...
    whatThisTeaches: [
      ...
      "Real records and systems remain outside the knowledge pack.",
      "Evidence preserves source, as-of date, assumptions, review, and disposition.",
      "Unknown disclosure or legal classification stops for authorized review.",
    ],
    whatThisDoesNotEnable: [
      "PACS connection",
      "county data access",
...
export const WIKI_PAGES: WikiPage[] = [
  ...
  },
  {
    ...
    title: "Brain Council",
    conceptType: "council",
    summary: "The static/read-only advisory reasoning layer.",
    canonicalDefinition:
      "Brain Council may inspect doctrine, cite evidence, frame options, assign confidence and risk, prepare decision packets, and recommend Work Orders; it cannot execute, call tools, activate Hermes/MCP, write memory, or bypass the Primary.",
    relatedSurfaces: ["/brain-council", "/work-orders", "/audit", "/governance", "/hermes"],
    relatedEvidence: ["Brain Council Advisory Layer", "WOE evidence clarity", "Hermes boundary doctrine"],
    relatedAuthority: ["COUNCIL_RUNTIME_GATE", "COMMAND_RUNNER_GATE", "HERMES_ACTIVATION_GATE", "MEMORY_WRITE_GATE"],
    relatedMemory: ["memory-owner-decision-queue-current", "memory-stale-contradiction-review"],
    relatedDecisions: ["decision-autonomy"],
    relatedTrace: ["trace-authority-refresh-pass", "trace-owner-not-courier-contract"],
    whatItIs: "A governed advisory model for evidence-backed recommendations.",
    whatItIsNot: "A runtime agent system, autonomous reasoning loop, tool invocation layer, Hermes/MCP activator, memory writer, or Work Order executor.",
  },
  {
    pageId: "wiki-hermes",
  ...
  },
  {
    ...
    title: "Trace Ledger",
    conceptType: "trace",
    summary: "The static proof-history layer for reasoning, failure learning, and eval candidates.",
    canonicalDefinition:
      "Trace Ledger records how goals, loops, WOs, evidence, memory, decisions, authority gates, Council advice, blockers, evidence gaps, confidence movement, and failure-to-eval candidates were reasoned through.",
    relatedSurfaces: ["/trace", "/work-orders", "/audit", "/brain-council"],
    relatedEvidence: ["Trace Ledger completion", "Brain Council Advisory Layer", "Failure-to-Eval candidate packet"],
    relatedAuthority: ["COMMAND_RUNNER_GATE", "AUTONOMOUS_LOOP_GATE", "MEMORY_WRITE_GATE", "TOOL_CALL_GATE"],
    relatedMemory: ["memory-stale-contradiction-review", "memory-authority-registry-current"],
    relatedDecisions: ["decision-command-execution", "decision-autonomy"],
    relatedTrace: ["trace-authority-refresh-pass", "trace-brain-council-advisory-complete"],
    whatItIs: "A static reasoning record and eval-candidate proposal model.",
    whatItIsNot: "Runtime tracing, telemetry service, background collection, eval runner, command runner, memory write, or dynamic ingestion.",
  },
  {
...
export const WILLIAMOS_GLOSSARY: GlossaryTerm[] = [
  ...
  ["Council Decision Packet", "A static recommendation packet with evidence, confidence, risk, authority, validation, and next safe gate.", "governance"],
  ["Council Confidence", "A Council recommendation level that rises or falls with cited evidence and known unknowns.", "governance"],
  ["Council Risk", "A Council risk label that escalates on auth, DB/schema, env/package, production, autonomy, Hermes/MCP, memory, TerraFusion/PACS, or secret boundaries.", "safety"],
  ...
  ["Evidence Gap", "Missing, stale, contradicted, or incomplete proof that lowers or blocks confidence.", "governance"],
  ["Confidence Movement", "A static explanation of why confidence rose, fell, stayed unchanged, or became blocked.", "governance"],
  ["Eval Candidate", "A proposed future eval packet that remains blocked until explicit authority.", "system"],
