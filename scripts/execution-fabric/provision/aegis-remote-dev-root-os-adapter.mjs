...
export function inspectExactInertNetworkPredecessor(o) {
  const keys=["firstReceiptExact","secondReceiptExact","nftSemanticExact","egressEnabledInactive","brokerInactiveDisabled","gitSocketInactiveDisabled","gitServiceInactive","listenerConnectionsAbsent","workerWorkspaceDispatchAbsent"]
